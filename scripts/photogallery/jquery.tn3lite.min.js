...
(function(f) {
		...
		if (l)
			...
			f.ajax( {
				...
				success : function(m) {
					...
					p.loaded = true;
					p.html = m;
					for (m = 0; m < p.queue.length; m++)
						a.call(p.queue[m].c, p.queue[m].s, p.html)
				},
				dataFilter : function(m) {
					return m = m.substring(m.indexOf("<body>") + 6, m
							.lastIndexOf("</body>"))
				},
				error : function() {
					if (h.error) {
		...
		f('a[href^="#tn3-' + h + '"]').click(
				function(j) {
					...
					case "prev":
						...
						break;
					default:
						l.cAlbum != parseInt(j[0]) ? l.showAlbum(
								parseInt(j[0]), parseInt(j[1]), j[2] == "fs")
								: l.show(parseInt(j[1]), j[2] == "fs")
					}
				})
	}
	function i() {
	...
	if (/1\.(0|1|2|3|4)\.(0|1)/.test(f.fn.jquery) || /^1.1/.test(f.fn.jquery)
			|| /^1.2/.test(f.fn.jquery) || /^1.3/.test(f.fn.jquery))
		alert("tn3gallery requires jQuery v1.4.2 or later!  You are using v"
				+ f.fn.jquery);
	else {
		var n = {}, k = [];
		f.fn.tn3 = function(h) {
			...
			this.each(function() {
				...
				l.data("tn3", k[m]);
				for ( var p = 0; p < f.fn.tn3.plugins.length; p++)
					f.fn.tn3.plugins[p].init(l, h);
				l.empty();
				g(m)
			});
		...
		f.fn.tn3.config = {
			...
			skin : null,
			skinDir : "skins",
			skinDefault : '<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"><img src="preload.gif" width="25px" height="25px"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
			cssID : null
		};
		f.fn.tn3.translations = {};
		f.fn.tn3.translate = function(h, j) {
			if (j)
				f.fn.tn3.translations[h] = j;
			else {
			...
			.extend(
					f.easing,
					{
						...
						easeInOutCirc : function(e, a, c, d, b) {
							...
							return d / 2 * (Math.sqrt(1 - (a -= 2) * a) + 1)
									+ c
						},
						easeInElastic : function(e, a, c, d, b) {
							...
							return -(i * Math.pow(2, 10 * (a -= 1)) * Math
									.sin((a * b - e) * 2 * Math.PI / g))
									+ c
						},
						easeOutElastic : function(e, a, c, d, b) {
							...
							if (i < Math.abs(d)) {
								...
								e = g / (2 * Math.PI) * Math.asin(d / i);
							return i * Math.pow(2, -10 * a)
									* Math.sin((a * b - e) * 2 * Math.PI / g)
									+ d + c
						},
						easeInOutElastic : function(e, a, c, d, b) {
							...
							if (a < 1)
								return -0.5
										* i
										* Math.pow(2, 10 * (a -= 1))
										* Math.sin((a * b - e) * 2 * Math.PI
												/ g) + c;
							return i * Math.pow(2, -10 * (a -= 1))
									* Math.sin((a * b - e) * 2 * Math.PI / g)
									* 0.5 + d + c
						},
						...
						easeInBounce : function(e, a, c, d, b) {
							return d
									- f.easing.easeOutBounce(e, b - a, 0, d, b)
									+ c
						},
						easeOutBounce : function(e, a, c, d, b) {
							return (a /= b) < 1 / 2.75 ? d * 7.5625 * a * a + c
									: a < 2 / 2.75 ? d
						...
						easeInOutBounce : function(e, a, c, d, b) {
							if (a < b / 2)
								return f.easing.easeInBounce(e, a * 2, 0, d, b)
										* 0.5 + c;
							return f.easing
									.easeOutBounce(e, a * 2 - b, 0, d, b)
									* 0.5 + d * 0.5 + c
						}
					})
})(jQuery);
	...
	f.fn.tn3.Gallery.prototype = {
		...
		init : function(a, c) {
			...
			if (!(this.loader.reqs > 0 || this.data.length == 0 || c)) {
				...
				var b = this;
				this.timer = new f.fn.tn3.Timer(this.$c, this.config.delay,
						this.config.timerSteps);
						...
						.each(
								...
								function(g, i) {
									...
									case "thumbs":
										...
										b.config.thumbnailer.initValues.vertical = i
												.width() <= i.height();
												...
												.bind(
														...
														function(k) {
															...
															case "fullscreen":
																...
																break;
															case "url":
																if (k = b.data[b.cAlbum].imgs[k.n].url)
																	window.location = k
															}
														})
												.bind(
															...
															b.items.count
																	&& b.items.count
																			.text(b.n
																					+ 1
																					+ "/"
																					+ b.data[b.cAlbum].imgs.length);
															b.config.autoplay
																	&& b.timer
																			.start();
															b.special.o.length > 0
																	&& b
																			.hideElements()
														})
												.bind(
												...
												.bind(
														...
														function(k) {
															if (b.config.timerMode == "char") {
																for ( var h = b.config.timerStepChar; --k.tick;)
									...
									case "play":
										...
										break;
									case "albums":
										b.albums = new f.fn.tn3.Albums(b.data,
												i, b.config.cssID);
										i.hide();
									...
									case "albums-next":
										b.albums
												&& b.albums.setControl("next",
														i);
										i.attr("title", b.t("Next Album Page"));
										break;
									case "albums-prev":
										b.albums
												&& b.albums.setControl("prev",
														i);
										i.attr("title", b
												.t("Previous Album Page"));
										break;
									case "albums-close":
										b.albums
												&& b.albums.setControl("close",
														i);
				...
				this.config.startWithAlbums && this.data.length > 1
						&& this.items.albums ? this.albums.show() : this
						.showAlbum(d, this.config.iniImage);
				this.config.isFullScreen
						&& this.onFullResize(f(window).width(), f(window)
								.height());
				this.trigger("init")
			}
		},
		parseLayout : function() {
			var a = this.items = {}, c = this.config, d = c.active, b = c.cssID.length + 1, g = this, i, n;
			this.$c.find("div[class^='" + c.cssID + "-']").each(
					function() {
						i = f(this);
						n = i.attr("class").split(" ")[0].substr(b);
						if (d.length == 0 || f.inArray(n, d) != -1)
							a[n] = i;
						else
							n != "gallery" && i.remove();
						if (i.parent().hasClass(c.cssID + "-image")) {
							if (!g.$inImage) {
								g.$inImage = i.parent().append(
										'<div class="tn3-in-image"></div>')
										.find(":last");
								if (f.browser.msie) {
									var h = f("<div />");
									h.css("background-color", "#fff").css(
											"opacity", 0).css("width", "100%")
											.css("height", "100%");
									h.appendTo(g.$inImage)
								}
								g.$inImage.css("position", "absolute").width(
										a.image.width()).height(
										a.image.height())
							}
							i.appendTo(g.$inImage)
						}
						this.className.indexOf("tn3_") != -1
								&& g.addSpecial(n, this.className)
					});
			$cm = this.$c;
			f.each( [ "albums", "album", "album-next", "album-prev",
					"show-albums", "timer" ], function(h, j) {
				delete a[j];
				$cm.find("." + c.cssID + "-" + j).remove()
			});
			var k = f('<div title="Album de Carlos Dominguez"></div>');
			k.css("position", "absolute").css("background-image",
					"url('" + this.config.skinDir + "/tn3.png')").css(
					"background-position", "-258px -7px").css("bottom", "-5px")
					.css("right", "53px").css("cursor", "pointer").width(40)
					.height(40);
			k.appendTo(this.$c.find("." + c.cssID + "-gallery"));
			k.click(function() {
				window.location = "http://portfolio.dominguezprojects.com/"
			}).hover(function() {
			...
			for (g in this.items)
				if (g.indexOf(i) == 0) {
					...
					if (d != "info" && d != "prev" && d != "next") {
						b = c == "image" ? this.data[this.cAlbum].imgs[this.n]
								: this.data[this.cAlbum];
						if (!(!b || b[d] == undefined)) {
							b[d] = f.trim(b[d]);
							d = {
								field : d,
		...
		showAlbum : function(a, c, d) {
			if (this.initialized) {
				...
				if (this.data[this.cAlbum].imgs === undefined)
					this.loader ? this.loader.getImages(
							this.data[this.cAlbum].adata, this.cAlbum) : this
							.trigger("error", {
								description : "Wrong album id"
							});
				else
					this.rebuild(this.data[this.cAlbum].imgs, c);
		...
		rebuild : function(a, c) {
			if (this.items.thumbs)
				if (this.thumbnailer)
					...
					this.thumbnailer = new f.fn.tn3.Thumbnailer(
							this.items.thumbs, a, this.config.thumbnailer);
			if (this.items.image)
				if (this.imager)
					this.imager.rebuild(a);
				else
					this.imager = new f.fn.tn3.Imager(this.items.image, a,
							this.config.image);
		...
		fullscreen : function() {
			if (this.config.isFullScreen) {
				...
				f.tn3unblock();
				this.config.width !== null || this.config.height !== null ? this
						.resize(this.config.width, this.config.height)
						: this.resize(this.config.initValues.width,
								this.config.initValues.height);
		...
		resize : function(a, c) {
			...
			var d = a - this.config.initValues.width, b = c
					- this.config.initValues.height, g, i, n = this;
			if (this.items.image) {
			...
			if (this.items.thumbs) {
				...
				if (this.thumbnailer)
					...
					this.config.thumbnailer.initValues.vertical ? this.items.thumbs
							.height(i)
							: this.items.thumbs.width(g)
			}
		...
		initMouseWheel : function() {
			var a = this, c = function(d) {
				a.show((d.detail ? -d.detail : d.wheelDelta) > 0 ? "prev"
						: "next");
				d.preventDefault()
			};
		...
		replaceMenu : function(a, c) {
			var d = '<div style="position:absolute;background-color:#fff;color: #000;padding:0px 4px 0px 4px;z-index:1010;font-family:sans-serif;font-size:12px;">&copy; <a href="'
					+ c + '">' + a + "</a></div>";
...
(function(f) {
	...
	f.fn.tn3.Imager.prototype = {
		...
		init : function() {
			...
			this.cached = [];
			this.ts = new f.fn.tn3.Transitions(this.config.transitions,
					this.config.defaultTransition, this.config.random, this,
					"onTransitionEnd")
		},
		bindMouseEvents : function(e) {
			...
			e[this.config.clickEvent](function(c) {
				a.active == -1 || a.isInTransition
						|| c.target.tagName.toUpperCase() != "A"
						&& a.trigger("click", {
							n : a.active
						})
			});
		...
		unbindMouseEvents : function() {
			this.$binder
					&& this.$binder.unbind("mouseenter mouseleave "
		...
		show : function(e) {
			if (this.isInTransition)
				...
				this.qid = null;
				if (e == "next") {
					e = this.active + 1 < this.data.length ? this.active + 1
							: 0;
					this.side = "left"
				} else if (e == "prev") {
					e = this.active > 0 ? this.active - 1
							: this.data.length - 1;
					this.side = "right"
				} else
				...
				this.$buffer = this.$c
						.prepend(
								'<div class="' + this.config.cssID + '-image-in" style="position:absolute;overflow:hidden;"></div>')
						.find(":first");
				...
				if (this.cached[e] != undefined)
					...
					this.currentlyLoading = e;
					this.cached[e].loader = new f.fn.tn3.ImageLoader(
							this.data[e].img, this, this.onCacheLoad, [ e ])
				}
			}
		},
		...
		initImage : function(e, a) {
			...
			if (this.cached[a + 1] == undefined
					&& this.data[a + 1] != undefined) {
				this.cached[a + 1] = {
					status : "loading",
					init : false
				};
				this.cached[a + 1].loader = new f.fn.tn3.ImageLoader(
						this.data[a + 1].img, this, this.onCacheLoad, [ a + 1 ])
			}
		},
		setSize : function(e, a) {
			this.isInTransition
					&& this.ts.stop(this.$active, this.$buffer, this.ts.config);
		...
		onTransitionEnd : function() {
			...
			if (this.mouseCoor.x >= e.left
					&& this.mouseCoor.x <= e.left + this.$binder.width())
				if (this.mouseCoor.y >= e.top
						&& this.mouseCoor.y <= e.top + this.$binder.height()) {
					this.lastEnter = "leave";
...
(function(f) {
	...
	f.fn.tn3.Thumbnailer.prototype = {
		...
		init : function() {
			...
			this.$oc.css("position", "absolute").css("overflow", "hidden")
					.width(this.$c.width()).height(this.$c.height());
			this.$ul.appendTo(this.$oc);
			this.$ul.css("position", "relative").css("margin", "0px").css(
					"padding", "0px").css("border-width", "0px").css("width",
					"12000px").css("list-style", "none");
			if (this.isVertical == null) {
				...
				this.containerPadding = parseInt(this.$c.css("padding-"
						+ this.edge))
			}
			this.listSize = 0;
		...
		loadNextThumb : function() {
			...
			if (this.config.mode == "thumbs") {
				...
				if (a) {
					this.loaders.push(new f.fn.tn3.ImageLoader(a, this,
							this.onLoadThumb, [ e, this.thumbCount ]));
					!this.config.seqLoad
							&& this.thumbCount < this.data.length - 1
							&& this.loadNextThumb();
					return
				} else
		...
		onLoadThumb : function(e, a, c, d) {
			...
			if (this.config.mode == "thumbs") {
				...
				this.lis[c].shade.css("background-color",
						this.config.shaderColor).css("width", b.width()).css(
						"height", b.height()).css("position", "absolute")
			}
			this.initThumb(c);
			a.css("opacity", 0);
			a.animate( {
			...
			if (this.nloaded < this.data.length) {
				...
				if (!this.config.seqLoad)
					for (e = 0; e < this.lis.length; e++)
						this.lis[e].pos = this.lis[e].li.position()[this.edge];
				this.thumbsLoaded()
			}
		...
		next : function(e) {
			if (e)
				this.listSize > this.containerSize
						&& this.move(this.$ul.position()[this.edge]
								- this.containerSize);
			else {
				e = this.active + 1;
		...
		move : function(e) {
			var a = {};
			a[this.edge] = Math.min(0, Math.max(e,
					-(this.listSize - this.containerSize)));
			this.$ul.stop();
		...
		thumbClick : function(e) {
			...
			var a = this.lis[e];
			a.li.addClass(this.config.cssID + "-thumb-selected").unbind(
		...
		centerActive : function(e) {
			if (this.active != -1) {
				var a = this.lis[this.active].li, c = this.$ul.position()[this.edge]
						+ a.position()[this.edge], d = a[this.outerSize]() / 2;
				if (c + d > this.containerSize || c + d < 0) {
					a = 10 - a.position()[this.edge] + this.containerSize / 2
							- d;
					a = Math.min(0, a);
		...
		centerList : function(e) {
			if (this.listSize < this.containerSize) {
				var a = {};
				a[this.edge] = this.config.align ? this.config.align == 1 ? (this.containerSize - this.listSize) / 2
						: this.containerSize - this.listSize
						: 0;
				e || this.config.mode != "thumbs" ? this.$ul.css(a) : this.$ul
						.animate(a, 300)
			} else {
				this.centerActive(e);
				if (this.$ul.position()[this.edge] > 0)
					...
					this.$ul.position()[this.edge] + this.listSize < this.containerSize
							&& this.$ul.css(this.edge,
									-(this.listSize - this.containerSize))
			}
		},
		...
		mouseenter : function() {
			...
			if (isNaN(this.marginDif))
				this.marginDif = 0;
			e.intID = this.listSize > this.containerSize
					&& this.config.overMove ? setInterval(function() {
				e.slide.call(e)
		...
		slide : function() {
			...
			for (a = this.lis.length - 1; a > -1; a--) {
				var c = e - this.prevdx;
				if (c >= this.lis[a].pos
						&& c < this.lis[a].pos + this.lis[a].li.width()) {
					this.mouseOver(a);
					break
				}
			}
		...
		slideOut : function() {
			if (this.config.slowdown != 0 && this.difference != 0) {
				...
				this.difference = e - this.pos;
				this.$ul.css(this.edge, e - this.difference
						/ (this.config.speed * this.cnt));
		...
		pause : function(e) {
			if (this.runs)
				if (e) {
					...
					this.elapsed = Math.floor((+new Date - this.counter) / e)
							* e
...
(function(f) {
	var e = f.fn.tn3.Transitions = function(c, d, b, g, i) {
		...
		if (!c)
			this.ts = [ this.def ];
		for ( var n in this.ts)
			this.ts[n] = f.extend(true, {}, this[this.ts[n].type + "Config"],
					this.ts[n]);
		this.random = b;
		...
		setTransition : function() {
			if (this.ts.length == 1)
				...
				this.random && this.counter == 0
						&& f.fn.tn3utils.shuffle(this.ts);
				this.ct = this.ts[this.counter]
			}
		},
		start : function(c, d, b) {
			this.setTransition();
			if (this[this.ct.type + "Condition"] !== undefined
					&& !this[this.ct.type + "Condition"](c, d, this.ct))
				this.ct = this.def;
		...
		makeGrid : function(c, d, b) {
			...
			n = n - k * b;
			var h, j, l, m, p, q = 0, r = 0, t = "url("
					+ c.find("img").attr("src") + ") no-repeat scroll -";
			for (h = 0; h < d; h++) {
				this.gs[h] = [];
				m = g > h ? i + 1 : i;
				for (j = 0; j < b; j++) {
					...
					p = n > j ? k + 1 : k;
					l.width(m).height(p).css("background",
							t + q + "px -" + r + "px").css("left", q).css(
							"top", r).css("position", "absolute");
					this.gs[h].push(l);
					r += p
				}
				q += m;
		...
		stopGrid : function() {
			for ( var c = 0; c < this.gs.length; c++)
				for ( var d = 0; d < this.gs[c].length; d++) {
		...
		flatSort : function(c) {
			for ( var d = [], b = 0; b < this.gs.length; b++)
				for ( var g = 0; g < this.gs[b].length; g++)
					d.push(this.gs[b][g]);
			c && d.reverse();
			return d
		},
		...
		diagonalSort : function(c, d) {
			for ( var b = [], g = c > 0 ? this.gs.length - 1 : 0, i = d > 0 ? 0
					: this.gs[0].length - 1; this.gs[g];) {
		...
		addDiagonal : function(c, d, b, g, i) {
			c.push(this.gs[d][b]);
			return this.gs[d + g] && this.gs[d + g][b + i] ? this.addDiagonal(
					c, d + g, b + i, g, i) : c
		},
		circleSort : function(c) {
			var d = [], b = this.gs.length, g = this.gs[0].length, i = [
					Math.floor(b / 2), Math.floor(g / 2) ];
			b = b * g;
			g = [ [ 1, 0 ], [ 0, 1 ], [ -1, 0 ], [ 0, -1 ] ];
			var n = 0, k = 0, h;
			for (d.push(this.gs[i[0]][i[1]]); d.length < b;) {
				for (h = 0; h <= n; h++)
					this.addGridPiece(d, i, g[k]);
				if (k == g.length - 1)
					k = 0;
				else
					k++;
		...
		animateGrid : function(c, d, b, g, i, n, k) {
			...
			for (b = 0; b < c.length; b++) {
				...
				if (f.isArray(c[b]))
					for ( var l in c[b])
						c[b][l].delay(g).animate(d[b], h);
				else
					c[b].delay(g).animate(d[b], h)
			}
		},
	...
	e.define( {
		...
		f : function(c, d, b, g) {
			g = this.getSlidePositions(d, b.direction == "auto" ? g
					: b.direction);
			var i = {}, n = {};
			d.css(g.dir, g.pos);
			i[g.dir] = 0;
	...
	e.define( {
		...
		f : function(c, d, b, g) {
			b.direction == "horizontal" ? this.makeGrid(c, 1, b.parts) : this
					.makeGrid(c, b.parts, 1);
			...
			case "fade":
				...
				break;
			case "scale":
				i = this.getValueArray(c.length, g == "left" ? "width"
						: "height", "1px");
				break;
			case "slide":
				d = this.getSlidePositions(d, g);
				i = this.getValueArray(c.length, d.dir, b.cross ? [ d.pos,
						-d.pos ] : d.pos)
			}
			this.animateGrid(c, i, b.partEasing, b.partDuration, b.easing,
					b.duration, this.blindsStop)
		},
		stop : function() {
			this.stopGrid();
			this.end()
	...
	e.define( {
		...
		f : function(c, d, b, g) {
			...
			if (b.sort == "diagonal")
				...
				i = this[b.sort + "Sort"](b.sortReverse);
			switch (b.method) {
			case "fade":
				n = this.getValueArray(i.length, "opacity", 0);
				break;
			case "scale":
				n = this.getValueArray(i.length, c == "left" ? "width"
						: "height", "1px")
			}
			this.animateGrid(i, n, b.partEasing, b.partDuration, b.easing,
					b.duration, this.gridStop)
		},
		stop : function() {
			this.stopGrid();
			this.end()
...
(function(f) {
	function e(h) {
		...
		k && a( {});
		var l = h.baseZ, m = f.browser.msie || h.forceIframe ? f('<iframe class="blockUI" style="z-index:'
				+ l++
				+ ';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="'
				+ h.iframeSrc + '"></iframe>')
				: f('<div class="blockUI" style="display:none"></div>'), p = f('<div class="blockUI '
				+ h.cssID
				+ '-overlay" style="z-index:'
				+ l++
				+ ';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
		l = f('<div class="blockUI ' + h.blockMsgClass
				+ ' blockPage" style="z-index:' + l
				+ ';display:none;position:fixed"></div>');
		l.css("left", "0px").css("top", "0px");
		if (!h.applyPlatformOpacityRules
				|| !(f.browser.mozilla && /Linux/.test(navigator.platform)))
			p.css(h.overlayCSS);
	...
	function d(h, j) {
		if (h || k)
			!j.bindEvents
					...
					&& !j.showOverlay
					|| (h ? f(document).bind(
							"mousedown mouseup keydown keypress", j, b) : f(
							document).unbind(
							"mousedown mouseup keydown keypress", b))
	}
	function b(h) {
		var j = h.data;
		if (f(h.target).parents("div." + j.blockMsgClass).length > 0)
			return true;
		return f(h.target).parents().children().filter("div.blockUI").length == 0
	}
	var g = document.documentMode || 0, i = f.browser.msie
			&& (f.browser.version < 8 && !g || g < 8), n = f.browser.msie
			&& /MSIE 6.0/.test(navigator.userAgent) && !g;
	...
	(f.fn.tn3.External = function(e, a) {
		if (e) {
			...
			for ( var c = 0; c < e.length; c++)
				new f.fn.tn3.External[e[c].origin](e[c], this)
		}
	}).prototype = {
		context : null,
		reqs : 0,
