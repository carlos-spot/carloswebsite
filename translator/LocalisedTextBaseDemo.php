    ...
    var $textBase = array(
        ...
        "en" => array(
            ...
            "aboutAutor"                 => "<h4>About the author: <a class=\"LinkCursor\" href=\"http://www.linkedin.com/pub/carlos-dominguez/35/442/224\" title=\"Posts by Carlos Dominguez\">
						...
						of his time writing for his website and developing software. You can find me on LinkedIn 
						<a class=\"LinkCursor\" href=\"http://www.linkedin.com/pub/carlos-dominguez/35/442/224\">linkedin.com/pub/carlos-dominguez/35/442/224</a>.</p>
                                            <p class=\"clear\"><a href=\"\"></a></p>",
            "technicalSkills"            => "Technical Skills",
            "technicalSkillsParagraph"   => "I have knowledge in OOP and structured programming, I manage perfectly the process that is needed for the development of software, 
                                            such as the requirements, analysis, development and testing applying the appropriate software documentation in UML. I have experience 
                                            working in teams, and guiding it to complete a project. 
                                            <br><br>Let me show a clearer way to display my strengths and weaknesses:
                                            <div id=\"skill-programming-languages\" style=\"min-width: 400px; height: 300px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-data-base\" style=\"min-width: 400px; height: 200px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-version-control-system\" style=\"min-width: 400px; height: 200px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-ide\" style=\"min-width: 400px; height: 300px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-technologies\" style=\"min-width: 400px; height: 300px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-personal-skills\" style=\"min-width: 400px; height: 300px; margin: 0 auto\"></div><br>",
            "programmingLanguage"        => "",
            "designPattern"              => "",
            "personalSkills"             => "",
            "readMore"                   => "Read More...",
            ...
            "academicHistoryParagraph"   => "I speak a 90 percent of English. I was the best average for the course on software engineer, and have developed and participated in the following projects:",
            ...
            "blogMicrosoftSurfaceText"   => "Microsoft Surface is a revolutionary 
                                            ...
                                            and 1920x1080 resolution. Designed for commercial environments. The product is 
            ...
            "blogw8TextFaceDetection"    => "Face detection or facial recognition has been around for a while, but never really 
            ...
            "blogMicrosoftStrategyText"  => "Hay personas que siempre anda hablando cosas malas de Microsoft, Microsoft es una empresa que ha 
                                            dado muchos empleos a las personas y ha ayudado a salir adelante a pequeñas empresas, pero que frustrante oir cosas 
            ...
            "infoResume"                 => "<p>Resume</p>
                                            <a href=\"downloads/resume-carlos-dominguez.pdf\" target=\"_blank\">
        ...
        "es" => array(
            ...
            "aboutAutor"                 => "<h4>Sobre el autor: <a class=\"LinkCursor\" href=\"http://www.linkedin.com/pub/carlos-dominguez/35/442/224\" title=\"Posteado por Carlos Dominguez\">
                                            ...
                                            para mi sitio web y desarrollando todo tipo de software. Tambien puedes encontrarme en LinkedIn 
                                            <a class=\"LinkCursor\" href=\"http://www.linkedin.com/pub/carlos-dominguez/35/442/224\">linkedin.com/pub/carlos-dominguez/35/442/224</a>.</p>
                                            <p class=\"clear\"><a href=\"\"></a></p>",
            "technicalSkills"            => "Habilidades t&eacute;cnicas",
            "technicalSkillsParagraph"   => "Tengo conocimientos en programación orientada a objetos y programación estructurada, manejo perfectamente el 
                                            proceso que se necesita para el desarrollo de un software como lo son la parte de requerimientos, análisis, 
                                            desarrollo y pruebas, aplicando la documentación apropiada del software en UML. Tengo experiencia trabajando 
                                            en equipo, y dirigiéndolo para finalizar un proyecto. 
                                            <br><br>Aquí muestro una forma más clara para visualizar mis fortalezas y debilidades.
                                            <div id=\"skill-programming-languages\" style=\"min-width: 400px; height: 300px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-data-base\" style=\"min-width: 400px; height: 200px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-version-control-system\" style=\"min-width: 400px; height: 200px; margin: 0 auto\"></div><br>
                                            <div id=\"skill-ide\" style=\"min-width: 400px; height: 300px; margin: 0 auto\"></div><br>
            ...
            "blogMicrosoftSurfaceText"   => "Microsoft Surface es un revolucionario equipo multi-touch que responde a los 
                                            ...
                                            de aspecto 16:9 y resolución de 1920 x 1080. Diseñado para entornos comerciales. El producto está diseñado para afrontar 
            ...
            "blogw8TextFaceDetection"    => "Detección de rostros o el reconocimiento facial ha existido por un tiempo, pero en realidad nunca fue 
            ...
            "infoResume"                 => "<p>Curriculum</p>
                                            <a href=\"downloads/curriculum-carlos-dominguez.pdf\" target=\"_blank\">
